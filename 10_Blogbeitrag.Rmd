...
Statt die Übereinstimmungen der Parteien zu zählen, können wir auch auf die oben als "Verwandschaftsbaum" betitelten Striche über der heatmap schauen (der korrekte Begriff ist übrigens Dendrogram). Parteien, die sehr viele Übereinstimmungen haben, sind "eng" verwandt. Im Verwandschaftsbaum würden sie also beide nah an einer gemeinsamen Abzweigung stehen. Um zu schauen, wie weit die SPD inhaltlich von den Grünen weg ist, können wir die Abzweigungen zwischen den beiden zählen: in diesem Fall eine Einzige. Das bedeutet, dass von diesen sechs Parteien die Grünen der SPD am ähnlichsten sind. Zum Vergleich: von der SPD zur Linken sind es schon zwei Abzweigungen, zur FDP sogar vier. 

### "Die beiden Volkspartein unterscheiden sich nicht mehr" - oder doch?
